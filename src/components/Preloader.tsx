...
const Preloader = () => (
  <div className="App container">
    ...
    Most them paid <b>$60,000 to $111,000</b> per year (1 standard deviation). 
    <span>
      The best city for an H1B is <b>Kirkland, WA</b> with an average individual salary  <b>$39,000</b> above the household median. Median household salary is a good proxy for cost of living in an area.
    </span>
    </p>
